...
Each property is going to be represented by an individual nft and by clicking the BUY button it will put the property in escrow so that it has to be approved uh you know by other parties and funded before it can actually finalize the transaction and the ownership of the property will change based on the NFt TO the seller.
...
Here is the video link for a demo presentation of the main interface and functionality of the project

[Link](https://drive.google.com/drive/folders/1133uWvSXFd-jj1SZ-ec_gozjtfXpGStE?usp=sharing)